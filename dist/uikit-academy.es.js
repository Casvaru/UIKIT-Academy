...
var $t = (s, t, e) => t in s ? yt(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var v = (s, t, e) => $t(s, typeof t != "symbol" ? t + "" : t, e);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = globalThis, K = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), tt = /* @__PURE__ */ new WeakMap();
let ut = class {
  constructor(t, e, r) {
...
const wt = (s) => new ut(typeof s == "string" ? s : s + "", void 0, X), L = (s, ...t) => {
  ...
  if (K) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
    ...
    const r = document.createElement("style"), a = T.litNonce;
    a !== void 0 && r.setAttribute("nonce", a), r.textContent = e.cssText, s.appendChild(r);
  }
}, et = K ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: At, defineProperty: St, getOwnPropertyDescriptor: Et, getOwnPropertyNames: Ct, getOwnPropertySymbols: Mt, getPrototypeOf: kt } = Object, m = globalThis, rt = m.trustedTypes, Pt = rt ? rt.emptyScript : "", R = m.reactiveElementPolyfillSupport, M = (s, t) => s, I = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? Pt : null;
      break;
  ...
  return e;
} }, vt = (s, t) => !At(s, t), at = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: vt };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, r) {
    const { get: a, set: i } = Et(this.prototype, t) ?? { get() {
      return this[e];
    }, set(o) {
      this[e] = o;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(M("properties"))) {
      const e = this.properties, r = [...Ct(e), ...Mt(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of r) e.unshift(et(a));
  ...
  _$ET(t, e) {
    ...
    if (a !== void 0 && r.reflect === !0) {
      const o = (((i = r.converter) == null ? void 0 : i.toAttribute) !== void 0 ? r.converter : I).toAttribute(e, r.type);
  ...
  _$AK(t, e) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const l = r.getPropertyOptions(a), n = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((i = l.converter) == null ? void 0 : i.fromAttribute) !== void 0 ? l.converter : I;
      this._$Em = a;
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[M("elementProperties")] = /* @__PURE__ */ new Map(), S[M("finalized")] = /* @__PURE__ */ new Map(), R == null || R({ ReactiveElement: S }), (m.reactiveElementVersions ?? (m.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const k = globalThis, st = (s) => s, N = k.trustedTypes, it = N ? N.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, gt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, bt = "?" + _, Zt = `<${bt}>`, x = document, P = () => x.createComment(""), Z = (s) => s === null || typeof s != "object" && typeof s != "function", Q = Array.isArray, Ht = (s) => Q(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", V = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ot = /-->/g, nt = />/g, y = RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), lt = /'/g, ct = /"/g, ft = /^(?:script|style|textarea|title)$/i, Lt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), d = Lt(1), A = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), dt = /* @__PURE__ */ new WeakMap(), $ = x.createTreeWalker(x, 129);
function _t(s, t) {
...
const zt = (s, t) => {
  ...
  let a, i = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = C;
  for (let l = 0; l < e; l++) {
    const n = s[l];
    let h, u, c = -1, g = 0;
    for (; g < n.length && (o.lastIndex = g, u = o.exec(n), u !== null); ) g = o.lastIndex, o === C ? u[1] === "!--" ? o = ot : u[1] !== void 0 ? o = nt : u[2] !== void 0 ? (ft.test(u[2]) && (a = RegExp("</" + u[2], "g")), o = y) : u[3] !== void 0 && (o = y) : o === y ? u[0] === ">" ? (o = a ?? C, c = -1) : u[1] === void 0 ? c = -2 : (c = o.lastIndex - u[2].length, h = u[1], o = u[3] === void 0 ? y : u[3] === '"' ? ct : lt) : o === ct || o === lt ? o = y : o === ot || o === nt ? o = C : (o = y, a = void 0);
    const f = o === y && s[l + 1].startsWith("/>") ? " " : "";
    i += o === C ? n + Zt : c >= 0 ? (r.push(h), n.slice(0, c) + gt + n.slice(c) + _ + f) : n + _ + (c === -2 ? l : f);
  }
  return [_t(s, i + (s[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class H {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let i = 0, o = 0;
    const l = t.length - 1, n = this.parts, [h, u] = zt(t, e);
    if (this.el = H.createElement(h, r), $.currentNode = this.el.content, e === 2 || e === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (a = $.nextNode()) !== null && n.length < l; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const c of a.getAttributeNames()) if (c.endsWith(gt)) {
          const g = u[o++], f = a.getAttribute(c).split(_), O = /([.?@])?(.*)/.exec(g);
          n.push({ type: 1, index: i, name: O[2], strings: f, ctor: O[1] === "." ? Tt : O[1] === "?" ? Nt : O[1] === "@" ? Ut : B }), a.removeAttribute(c);
        } else c.startsWith(_) && (n.push({ type: 6, index: i }), a.removeAttribute(c));
        if (ft.test(a.tagName)) {
          const c = a.textContent.split(_), g = c.length - 1;
          if (g > 0) {
            a.textContent = N ? N.emptyScript : "";
            for (let f = 0; f < g; f++) a.append(c[f], P()), $.nextNode(), n.push({ type: 2, index: ++i });
            a.append(c[g], P());
          }
        }
      } else if (a.nodeType === 8) if (a.data === bt) n.push({ type: 2, index: i });
      else {
        let c = -1;
        for (; (c = a.data.indexOf(_, c + 1)) !== -1; ) n.push({ type: 7, index: i }), c += _.length - 1;
      }
      i++;
    }
  }
...
function E(s, t, e = s, r) {
  var o, l;
  if (t === A) return t;
  let a = r !== void 0 ? (o = e._$Co) == null ? void 0 : o[r] : e._$Cl;
  const i = Z(t) ? void 0 : t._$litDirective$;
  return (a == null ? void 0 : a.constructor) !== i && ((l = a == null ? void 0 : a._$AO) == null || l.call(a, !1), i === void 0 ? a = void 0 : (a = new i(s), a._$AT(s, e, r)), r !== void 0 ? (e._$Co ?? (e._$Co = []))[r] = a : e._$Cl = a), a !== void 0 && (t = E(s, a._$AS(s, t.values), a, r)), t;
}
class Ot {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, a = ((t == null ? void 0 : t.creationScope) ?? x).importNode(e, !0);
    $.currentNode = a;
    let i = $.nextNode(), o = 0, l = 0, n = r[0];
    for (; n !== void 0; ) {
      if (o === n.index) {
        let h;
        n.type === 2 ? h = new z(i, i.nextSibling, this, t) : n.type === 1 ? h = new n.ctor(i, n.name, n.strings, this, t) : n.type === 6 && (h = new Bt(i, this, t)), this._$AV.push(h), n = r[++l];
      }
      o !== (n == null ? void 0 : n.index) && (i = $.nextNode(), o++);
    }
    return $.currentNode = x, a;
  }
  p(t) {
    let e = 0;
...
class z {
  ...
  constructor(t, e, r, a) {
    this.type = 2, this._$AH = p, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = r, this.options = a, this._$Cv = (a == null ? void 0 : a.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), Z(t) ? t === p || t == null || t === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ht(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    var i;
    const { values: e, _$litType$: r } = t, a = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = H.createElement(_t(r.h, r.h[0]), this.options)), r);
    if (((i = this._$AH) == null ? void 0 : i._$AD) === a) this._$AH.p(e);
    else {
      const o = new Ot(a, this), l = o.u(this.options);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let r, a = 0;
    for (const i of t) a === e.length ? e.push(r = new z(this.O(P()), this.O(P()), this, this.options)) : r = e[a], r._$AI(i), a++;
...
class B {
  ...
  constructor(t, e, r, a, i) {
    this.type = 1, this._$AH = p, this._$AN = void 0, this.element = t, this.name = e, this._$AM = a, this.options = i, r.length > 2 || r[0] !== "" || r[1] !== "" ? (this._$AH = Array(r.length - 1).fill(new String()), this.strings = r) : this._$AH = p;
  }
  _$AI(t, e = this, r, a) {
    const i = this.strings;
    let o = !1;
    if (i === void 0) t = E(this, t, e, 0), o = !Z(t) || t !== this._$AH && t !== A, o && (this._$AH = t);
    else {
      const l = t;
      let n, h;
      for (t = i[0], n = 0; n < i.length - 1; n++) h = E(this, l[r + n], e, n), h === A && (h = this._$AH[n]), o || (o = !Z(h) || h !== this._$AH[n]), h === p ? t = p : t !== p && (t += (h ?? "") + i[n + 1]), this._$AH[n] = h;
    }
    o && !a && this.j(t);
  }
  j(t) {
...
class Ut extends B {
  ...
  _$AI(t, e = this) {
    ...
    const r = this._$AH, a = t === p && r !== p || t.capture !== r.capture || t.once !== r.once || t.passive !== r.passive, i = t !== p && (r === p || a);
...
D == null || D(H, z), (k.litHtmlVersions ?? (k.litHtmlVersions = [])).push("3.3.2");
const Rt = (s, t, e) => {
  const r = (e == null ? void 0 : e.renderBefore) ?? t;
  let a = r._$litPart$;
  if (a === void 0) {
    const i = (e == null ? void 0 : e.renderBefore) ?? null;
    r._$litPart$ = a = new z(t.insertBefore(P(), i), i, void 0, e ?? {});
  }
  return a._$AI(s), a;
};
/**
...
var pt;
b._$litElement$ = !0, b.finalized = !0, (pt = w.litElementHydrateSupport) == null || pt.call(w, { LitElement: b });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vt = { CHILD: 2 }, Dt = (s) => (...t) => ({ _$litDirective$: s, values: t });
class jt {
  constructor(t) {
  }
  get _$AU() {
...
class F extends jt {
  constructor(t) {
    if (super(t), this.it = p, t.type !== Vt.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
`, ht = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon">
...
class G extends b {
  constructor() {
    super(), this.variant = "primary", this.types = void 0, this.size = "base", this.disabled = !1, this.active = !1, this.iconName = void 0, this.iconOnly = !1, this.ariaLabel = "", this.href = void 0, this.target = "_self";
  }
  connectedCallback() {
  ...
  _getIconSVG() {
    ...
    try {
      ...
      i && i.tagName.toLowerCase() === "svg" && (i.setAttribute("width", "1em"), i.setAttribute("height", "1em"), i.setAttribute("aria-hidden", "true"), i.setAttribute("fill", "currentColor"), e = i.outerHTML);
    } catch {
    }
    return e || "";
  }
  ...
  _getClasses() {
    const t = ["ac-button"];
    return this.types ? t.push(`ac-button--type-${this.types}`) : t.push(`ac-button--${this.variant}`), this.iconOnly && t.push("ac-button--icon-only"), this.size === "small" && t.push("ac-button--small"), this.disabled && t.push("ac-button--disabled"), this.active && t.push("ac-button--active"), t.join(" ");
  }
  render() {
    const t = this._getIconSVG(), e = d`
      ${t ? d`<span class="ac-button__icon">${U(t)}</span>` : d`<slot name="icon"></slot>`}
...
v(G, "styles", [It]), v(G, "properties", {
  variant: { type: String, reflect: !0 },
  types: { type: String, reflect: !0 },
...
customElements.define("ac-button", G);
const ne = L`
  :host {
    display: block;
...
v(W, "styles", [ne]), v(W, "properties", {
  heading: { type: String },
  description: { type: String }
});
customElements.define("ac-section-header", W);
const le = L`
  :host {
    display: block;
    box-sizing: border-box;
...
customElements.define("ac-card-dashboard", q);
const ge = L`
  :host {
    display: block;
    box-sizing: border-box;
...
class Y extends b {
  constructor() {
    super(), this.title = "", this.hasArrow = !1, this.href = "", this.target = "_self";
  }
  /** Get the SVG HTML for the icon */
  _getIconSVG(t) {
    if (!t || t !== "arrow-right") return "";
    let r = {
      "arrow-right": mt
    }[t];
    if (!r) return "";
    try {
      ...
      o && o.tagName.toLowerCase() === "svg" && (o.setAttribute("width", "1em"), o.setAttribute("height", "1em"), o.setAttribute("fill", "currentColor"), r = o.outerHTML);
    } catch {
    }
    return r || "";
  }
  render() {
    const t = this.title && this.hasArrow ? this._getIconSVG("arrow-right") : "";
    return d`
...
v(Y, "styles", [ge]), v(Y, "properties", {
  title: { type: String, reflect: !0 },
  hasArrow: { type: Boolean, reflect: !0, attribute: "has-arrow" },
  href: { type: String, reflect: !0 },
  target: { type: String, reflect: !0 }
});
customElements.define("ac-card", Y);
const be = L`
  :host {
    display: block;
    box-sizing: border-box;
...
v(J, "styles", [be]), v(J, "properties", {
  hasProfile: { type: Boolean, attribute: "has-profile" }
});
customElements.define("ac-header", J);
export {
  G as AcButton,
  Y as AcCard,
  q as AcCardDashboard,
  J as AcHeader,
  W as AcSectionHeader
};
